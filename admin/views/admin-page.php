...
$bulk_page_duplicator_post_types = get_post_types(array('public' => true), 'objects');
// Exclude attachments
unset($bulk_page_duplicator_post_types['attachment']);

// Get all pages for the initial dropdown
$bulk_page_duplicator_pages = get_pages(array(
...
$bulk_page_duplicator_core = new Bulk_Page_Duplicator_Core();
$bulk_page_duplicator_seo_plugins = $bulk_page_duplicator_core->detect_seo_plugins();
$bulk_page_duplicator_page_builders = $bulk_page_duplicator_core->detect_page_builders();
?>
<div class="wrap">
	...
	<div class="bulk-page-dup-container">
		<div class="bulk-page-dup-panel">
			...
			<select id="post-type" class="widefat">
				<?php foreach ($bulk_page_duplicator_post_types as $post_type) : ?>
			...
			<div id="parent-page-section">
				...
				<select id="parent-page" class="widefat">
					...
					<?php foreach ($bulk_page_duplicator_pages as $page) : ?>
			...
			<div class="bulk-page-dup-checkbox-group">
				...
				<?php foreach ($bulk_page_duplicator_page_builders as $bulk_page_duplicator_builder) : ?>
					<label><input type="checkbox" id="replace-<?php echo esc_attr($bulk_page_duplicator_builder['id']); ?>" checked> <?php echo esc_html($bulk_page_duplicator_builder['name']); ?> <?php esc_html_e('Data (if exists)', 'bulk-page-duplicator'); ?></label>
				<?php endforeach; ?>
				<?php if (!empty($bulk_page_duplicator_seo_plugins)) : ?>
